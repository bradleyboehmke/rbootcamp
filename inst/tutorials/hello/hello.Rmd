...
Welcome to this set of tutorials focused on providing a structured learning approach. Through these tutorials you will not only learn the fundamentals of R programming for exploratory data analysis, but you will also apply and perform knowledge checks as you progress through the tutorials. This is accomplished through:
...
```{r, eval=FALSE}
pkgs <- c("learnr", "tidyverse", "moments", "outliers", "GGally")
...
If you continue to have persistent problems that you cannot resolve please do not hestitate to report the issue at  [https://github.com/bradleyboehmke/rbootcamp/issues](https://github.com/bradleyboehmke/rbootcamp/issues).
