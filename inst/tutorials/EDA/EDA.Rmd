...
3. Understanding numerical and categorical variables through descriptive statistics 
4. Using visualization to understand your data
5. Performing basic inferential statistics to compare groups and identify relationships
...
question("Which JobCategory has the smallest average HHIncome?",
  answer("Crafts"),
  answer("Labor"),
  answer("Agriculture", correct = TRUE),
  answer("Professional"),
  random_answer_order = TRUE
)
)
...
2. group by *Age*
3. create a new variable that computes the percentage of car leasers
4. filter for only those customers that lease
5. arrange your percent leasers variable in descending order
...
quiz(caption = "Knowledge Check",
 question("What age has the highest percentage of leasers?",
  ...
  answer("22 years"),
  answer("65 years"),
  answer("78 years", correct = TRUE),
  random_answer_order = TRUE,
  allow_retry = TRUE
),
 question("What age has the lowest percentage of leasers?",
  answer("18 years", correct = TRUE),
  answer("22 years"),
  answer("65 years"),
  answer("79 years"),
  random_answer_order = TRUE,
...
The goal is to find the credit cards companies (*CreditCard*) with the largest percentage of defaulters (*LoanDefault*).  You can accomplish this by:

1. grouping the data by *CreditCard*, 
2. counting the number of *LoanDefault*, 
3. grouping by *LoanDefault*,
4. computing the percent of *LoanDefault* versus non defaulters.
